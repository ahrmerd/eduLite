...
class QuizAttemptController extends Controller
{
    ...
    public function show(QuizAttempt $quizAttempt)
    {
        ...
        return view('quiz-attempts.show', compact('quizAttempt', 'subject'));
    ...
    private function checkTimeLimit(QuizAttempt $quizAttempt)
    {
        ...
        // $elapsedTime = now()->diffInSeconds($quizAttempt->started_at);
    ...
    public function review(QuizAttempt $quizAttempt)
    {
        ...
        return view('quiz-attempts.review', compact('quizAttempt'));
