    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="flex-1 max-w-2xl">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Search by subject or link</p>
            </div>
            <x-mary-button
    ...
    <div class="overflow-hidden bg-white dark:bg-gray-800 rounded-lg shadow">
        <x-table 
            ...
            @scope('cell_link', $tutorial)
                   <a href='{{$tutorial->link}}' target="_blank" class="text-blue-600 dark:text-blue-400 hover:underline"> Visit </a>
            @endscope
        </x-table>
    </div>

    <x-mary-modal wire:model="createModal" class="backdrop-blur dark:bg-gray-900/90" title="Add New Tutorial">
        <livewire:admin.create-tutorial />
    </x-mary-modal>

    <x-mary-modal wire:model="editModal" class="backdrop-blur dark:bg-gray-900/90" title="Edit Tutorial">
        @if ($this->model != null)
