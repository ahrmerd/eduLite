...
<div class="p-3 border border-b rounded-md shadow-sm">
    <div class="flex items-center gap-3">
        <x-mary-input wire:model="value"
         label="{{ $this->label ?? Str::headline(Str::endsWith($this->attribute, '_id') ? Str::replaceLast('_id', '', $this->attribute) : $this->attribute)}}"

         inline name='{{$this->attribute}}' wire:keydown.enter='save' />
